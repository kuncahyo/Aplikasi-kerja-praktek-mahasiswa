            ...
            ?>
                <main>
                    <div class="container-fluid px-5">
                        <h1 class="mt-4">Pengumuman Kerja Praktek</h1>
                        <div class="content-wrapper">
                        <br>
                            <div class="card shadow mb-4 col-8 offset-2" style="background-color:#F8F8FF;">
                                <div class="card-body tab-content" id="myTabContent">
                                <form method="POST" action="proses/upload_pengumuman.php">
                                    <label class="form-label col-12">Isi Pengumuman :</label>
                                    ...
                                    <br><br>
                                    <input type="submit" class="btn btn-success" name="tambah-pengumuman">
                                </form>
                                </div>
                                </div>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body tab-content" id="myTabContent">
                                  ...
                                  <tr>
                                        ...
                                        <td><a class="btn btn-danger" href="delete/delete_pengumuman.php?id=<?php echo $row['id'];?>">Hapus</a></td>
                                    </tr>
                                    <?php
                                    };
                                    ?> 
