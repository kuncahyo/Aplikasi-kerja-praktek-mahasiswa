            ...
            ?>
                                 ...
                                 ?>
                                  ...
                                  <td>
                                    ...
                                    <?= $no++;?></td>
                                      ...
                                      <a href="delete/delete-kaprodi.php?hal=delete&id=<?= $row['id'];?>"
                ...
                <div class="modal fade" id="modal<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="col-12" role="form" action="edit/edit-kaprodi.php" method="post" enctype="multipart/form-data">
                            <div class="row">
