            ...
            ?>
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Sekertaris Prodi</h1>
                        <hr>
                    </div>
                    <div class="card mb-4">
                                 ...
                                 ?>
                                  ...
                                  <td>
                                    ...
                                    <?= $no++;?></td>
                                      ...
                                      <a href="delete/delete-sekpro.php?hal=delete&id=<?= $row['id'];?>"
                ...
                <div class="modal fade" id="modal<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="col-12" role="form" action="edit/edit-sekpro.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                            <input type="text" hidden name="id" id="id" value="<?php echo $row['id']?>">
                            <label class="form-label col-12">NIDN :</label>
                            <input type="text" name="nidn" id="nidn" class="form-control" value="<?php echo $row['nidn']?>">
                          ...
                          <?php }else if($row["status"] == 'PPKP'){ ?>
                            <option value="Dosen" >Dosen</option>
                              ...
                              <option value="Kaprodi">Kaprodi</option>
                              <option value="Sekpro">Sekertaris Prodi</option>
                          <?php }else if($row["status"] == 'Sekpro'){ ?>
                            <option value="Dosen" >Dosen</option>
                              <option value="Mahasiswa">Mahasiswa</option>
                              <option value="PPKP">PPKP</option>
                              <option value="Kaprodi">Kaprodi</option>
                              <option value="Sekpro" selected>Sekertaris Prodi</option>
                          <?php }else { ?>
                            <option value="Dosen">Dosen</option>
                              <option value="Mahasiswa">Mahasiswa</option>
                              <option value="PPKP">PPKP</option>
