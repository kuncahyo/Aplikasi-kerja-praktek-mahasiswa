                    ...
                    <div class="container-fluid px-4">
                        ...
                        <table id="datatablesSimple" class="display table table-striped table-bordered">
                            ...
                            //    echo $kodesesi;
                                ...
                                t.status, t.info FROM `tanda_tangan` t join `dosen` d on d.id_user=t.penerima join `mahasiswa_kp` m on t.mengajukan=m.id_user where d.id_user='$id_log' and t.status='pending';";
                                $query = mysqli_query($koneksi, $sql);
                                    while ($row = mysqli_fetch_array($query))
                                        ...
                                        <td><?php echo $no++;?></td>
                                            ...
                                            <td><a class="btn btn-success" href="tanda-tangan-dosen.php?id_ttd=<?php echo $row['id'];?>">aksi</a></td>
                                        </tr>
                                <?php 
                                    }
                                    ?>
                       ...
                       //echo $koneksi;
                                ...
                                $kodesesi=$_SESSION['id'];
                                $sql = "SELECT t.id, m.nama_mahasiswa, d.name, t.tipe, t.file, t.tanggal, 
                                t.status, t.info FROM `tanda_tangan` t join `dosen` d on d.id_user=t.penerima join `mahasiswa_kp` m on t.mengajukan=m.id_user where d.id_user='$id_log' and t.status='Approve';";
                                $query = mysqli_query($koneksi, $sql);
                                    while ($row = mysqli_fetch_array($query))
                                        {
                                        ?>
                       ...
                       //echo $koneksi;
                                ...
                                $kodesesi=$_SESSION['id'];
                                $sql = "SELECT t.id, m.nama_mahasiswa, d.name, t.tipe, t.file, t.tanggal, 
                                t.status, t.info FROM `tanda_tangan` t join `dosen` d on d.id_user=t.penerima join `mahasiswa_kp` m on t.mengajukan=m.id_user where d.id_user='$id_log' and t.status='Decline';";
                                $query = mysqli_query($koneksi, $sql);
                                    while ($row = mysqli_fetch_array($query))
                                        {
                                        ?>
