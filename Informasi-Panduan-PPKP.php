            ...
            ?>
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Informasi Panduan PPKP</h1>
                        <hr>
                    </div>
                    <div class="card mb-4">
                                    ...
                                    <?php
                                     $no=1;
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-success" href="view/view-panduan-kp.php?nama=<?php echo $row['isi_pengumuman'];?>">Detail Informasi</a></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
