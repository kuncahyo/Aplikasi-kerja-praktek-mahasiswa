            ...
            ?>
                <main>
                    ...
                    <div class="card mb-4">
                       ...
                       $no=1;
                    //    echo $kodesesi;
                          $sql = 'Select * from Dosen where status_akun= "RequestLogin"';
                ...
                <div class="modal fade" id="exampleModal1<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="col-12" role="form" action="proses/aprove-login-dosen.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <input type="text" disabled name="nama" id="nama" value="<?php echo $row['name']?>">
