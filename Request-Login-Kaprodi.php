            ...
            ?>
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Login Kaprodi</h1>
                        <hr>
                    </div>
                    <div class="card mb-4">
                       ...
                       $no=1;
                    //    echo $kodesesi;
                          $sql = 'Select * from kaprodi where status_akun= "RequestLogin"';
                ...
                <div class="modal fade" id="exampleModal1<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="col-12" role="form" action="proses/aprove-login-kaprodi.php" method="post" enctype="multipart/form-data">
                            <div class="row">
