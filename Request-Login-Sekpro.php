            ...
            ?>
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Login Sekertaris Prodi</h1>
                        <hr>
                    </div>
                    <div class="card mb-4">
                        <div class="row col-md-12">    
                            <div class="card-header col-md-12">
                               ...
                               Request Login Sekertaris Prodi
                            </div>
                        </div>
                            <div class="card-body">
                       ...
                       $no=1;
                    //    echo $kodesesi;
                          $sql = 'Select * from sekpro where status_akun= "RequestLogin"';
                ...
                <div class="modal fade" id="exampleModal1<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="col-12" role="form" action="proses/aprove-login-sekpro.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                            <input type="text" hidden name="id" id="id" value="<?php echo $row['id']?>">
                            <label class="form-label col-12">NIDN :</label>
                            <input type="text" disabled name="nidn" id="nidn" value="<?php echo $row['nidn']?>">
                            <label class="form-label col-12">Nama :</label>
                            <input type="text" disabled name="nama" id="nama" value="<?php echo $row['nama']?>">
