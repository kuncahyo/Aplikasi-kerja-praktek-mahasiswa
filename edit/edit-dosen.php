...
include '../koneksi/koneksi.php';
    ...
    //       if ($row["total"] < 1){
                $sql = "update dosen SET nidn='".$nidn."',prodi='".$prodi."',name='".$name."',email='".$email."',status='".$status."',status_akun='".$status_akun."' where id = '".$id."'";
                $result = $koneksi->query($sql);

            
                echo "<script type='text/javascript'>location.replace('../Editing-dosen.php');</script>";
    //         }else{
