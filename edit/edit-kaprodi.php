...
include '../koneksi/koneksi.php';
    ...
    //       if ($row["total"] < 1){
                $sql = "update kaprodi SET nidn='".$nidn."',prodi='".$prodi."',nama='".$name."',email='".$email."',status='".$status."',status_akun='".$status_akun."' where id = '".$id."'";
                $result = $koneksi->query($sql);

            
                echo "<script type='text/javascript'>location.replace('../Editing-kaprodi.php');</script>";
    //         }else{
