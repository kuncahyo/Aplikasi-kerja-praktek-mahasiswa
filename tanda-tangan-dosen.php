                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="content-wrapper ">
                            ...
                            <form method="POST" action="proses/proses-tanda-tangan-dosen.php" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            //    echo $kodesesi;
                                ...
                                t.status, t.info FROM `tanda_tangan` t join `dosen` d on d.id_user=t.penerima join `mahasiswa_kp` m on t.mengajukan=m.id_user where d.id_user='.$id_log.' and t.id='.$_GET['id_ttd'].';';
                                $query = mysqli_query($koneksi, $sql);
                                    while ($row = mysqli_fetch_array($query))
                                        ...
                                        <td><?php echo $no++;?></td>
                                            ...
                                            <td><a class="btn btn-success" href="view/view-ttd-kp.php?nama=<?php echo $row['file'];?>">ini do</a></td>
                                        </tr>
                                <?php 
                                    }
                                    ?>
