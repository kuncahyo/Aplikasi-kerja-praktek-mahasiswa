                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="content-wrapper ">
                            ...
                            <form method="POST" action="proses/proses-tanda-tangan-kaprodi.php" enctype="multipart/form-data">
                        ...
                        <table id="datatablesSimple" class="display table table-striped table-bordered">
                            ...
                            //    echo $kodesesi;
                                ...
                                t.status, t.info FROM `tanda_tangan` t join `kaprodi` d on d.id_user=t.penerima join `mahasiswa_kp` m on t.mengajukan=m.id_user where d.id_user='.$id_log.' and t.id='.$_GET['id_ttd'].';';
